...
def fanyi(word):
    ...
    res = requests.post(post_url, headers=headers, params=params)
    return res.json()
...
if __name__ == '__main__':
    while True:
        ...
        print(results)
#
# OUTFOX_SEARCH_USER_ID=-1481923581@10.108.162.135; OUTFOX_SEARCH_USER_ID_NCOO=1666373729.1783562; ___rl__test__cookies=1653062612829
# OUTFOX_SEARCH_USER_ID=-1481923581@10.108.162.135; OUTFOX_SEARCH_USER_ID_NCOO=1666373729.1783562; ___rl__test__cookies=1653062664828