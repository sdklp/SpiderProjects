...
class MySpiderMiddleeware:
    ...
    proxy_url_list=[
        'https://119.123.175.200:9797',
        # 'https://49.85.188.171:8058',
        # 'https://218.2.214.107:80',
        # 'https://150.138.253.73:808',
    ]
    def process_request(self, request, spider):
        user_agent=random.choices(self.user_agent_list)
        proxy_url=random.choices(self.proxy_url_list)
        request.headers['User-Agent']=user_agent
        request.meta['proxy'] = 'https://119.123.175.200:9797'
